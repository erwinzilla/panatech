<div class="main-sidebar">
    ...
    <ul class="nav nav-pills flex-column" id="sidebar">
        <li class="nav-item mb-1">
            <a href="{{ $type == 'data' ? '#main' : url($config['url']) }}" class="nav-link" aria-current="page">@svg('heroicon-o-user-group', 'icon') Customer Type</a>
        </li>
        <li class="nav-item mb-1">
            <a href="{{ $type == 'create' ? '#main' : url($config['url'].'/create') }}" class="nav-link">@svg('heroicon-o-plus', 'icon') Create new</a>
        </li>
        <li class="nav-item mb-1">
            <a href="{{ url('customer') }}" class="nav-link">@svg('heroicon-o-user', 'icon') Customer</a>
        </li>
